...
class TestLogRequestFunction:
    ...
    async def test_log_request_creates_audit_service(self):
        ...
        with patch("app.services.audit.AuditService") as mock_audit_service:
            mock_service = AsyncMock()
            mock_audit_service.return_value = mock_service
            ...
            mock_audit_service.assert_called_once_with(db)
